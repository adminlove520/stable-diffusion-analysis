<template>
  <div class="text-center p-6 max-w-1024px mx-auto">
    <h1 class="font-bold text-3xl">Stable Diffusion 解析</h1>
    ...
    <div class="my-4 pt-4">
      ...
      <a class="inline-block text-sm text-gray-500"
        href="https://github.com/adminlove520/stable-diffusion-analysis">GitHub</a>
      ←上点个star
      <br />
      <span class="inline-block mt-2 text-sm text-gray-500">
        Made with ❤️ by
        <a class="text-gray-500" href="https://github.com/adminlove520">@东方隐侠·Anonymous</a>
        <a> | </a>
